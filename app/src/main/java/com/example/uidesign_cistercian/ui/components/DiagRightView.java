...
public class DiagRightView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public DiagRightView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void init() {
        ...
        diagonalPath.reset();
        diagonalPath.moveTo(getWidth(), 0); // Start at the top-right corner
        diagonalPath.lineTo(0, getHeight()); // Draw to the bottom-left corner
        diagonalPath.lineTo(STROKE_WIDTH, getHeight()); // Account for stroke width
        diagonalPath.lineTo(getWidth(), STROKE_WIDTH); // Draw back to the top-right, offset by stroke width
